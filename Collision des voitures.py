...
vitesse_finale1 = float(input("Entrer la vitesse finale (m/s) souhaité du vehicule 1:"))
...
while True:  # le loop fait en sorte que si l'utilisateur met une valeur hors de -20 et 20, ca affiche un message d'erreur tant qu'il met une valeur valide
    positionfinale_x_1 = float(input(
...
vitesse_finale2 = float(input("Entrer la vitesse finale souhaité du vehicule 2:"))
...
while True:
    positionfinale_y_2 = int(
        input("Indiquer la position finale de la voiture 2 en y entre -20m et 20m du deuxième vehicule:"))
...
donnes_dict = {
    ...
    'Position vers la quelle la voiture se dirigeait (m)': [vitesse_finale1, vitesse_finale2],
